...
class SnapShot:
    ...
    def _find_access(self, i, j):

        self._used[i][j] = True
        if self.table[i][j] != State.RED_CROSS and self.table[i][j] != State.RED_TOWER: return
